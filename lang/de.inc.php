...
$messages['userexists'] = "Dieser Account existiert bereits";
$messages['cn'] = "Vollständiger Name";
$messages['cnrequired'] = "Ihr vollständiger Name wird benötigt";
$messages['createhelp'] = "Registrieren Sie sich als neuer Benutzer";
$messages['menuregister'] = "Registrieren";
$messages['createhelpextramessage'] = "Geben Sie Ihre Daten an, um sich als neuer Benutzer zu registrieren. Sie bekommen eine Bestätigungsmail.";
$messages['emptyregisterform'] = "Registrieren Sie sich als neuer Benutzer";
$messages['usercreated'] = "Sie haben sich erfolgreich registriert";
$messages['usercreatedextramessage'] = "Sie müssten jetzt eine Bestätigungsmail erhalten haben.";
$messages['createerror'] = "Fehler beim erstellen des neuen Accounts";
$messages['createsubject'] = 'Erfolgreich registriert';
$messages['createmessage'] = "Hallo {login},\n\nIhre Registrierung bei O4I war erfolgreich. Sie können sich nun als {login} anmelden.";
